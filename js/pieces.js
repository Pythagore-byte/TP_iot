...
// //     // Ouvrir le formulaire Ajouter une pièce
// //     document.getElementById("open-add-piece-modal").addEventListener("click", () => {
// //         ouvrirModal("Ajouter une Pièce");
// //         document.getElementById("piece-id").value = ""; // Réinitialiser le champ ID
...
// //     // Gérer le formulaire Ajouter ou Modifier
// //     document.getElementById("piece-form").addEventListener("submit", (e) => {
// //         e.preventDefault();
// //         const idLogement = document.getElementById("logement-select").value;
// //         if (!idLogement) {
...
// //     ouvrirModal("Modifier une Pièce");
...
//     // Charger les pièces lorsque le logement change
//     document.getElementById("logement-select").addEventListener("change", (e) => {
//         const logementId = e.target.value;
//         if (logementId) {
//             chargerPieces(logementId);
...
//     // Gérer le modal Ajouter/Modifier une pièce
//     document.getElementById("open-add-piece-modal").addEventListener("click", () => {
//         ouvrirModal("Ajouter une Pièce");
...
async function chargerPieces(idLogement) {
    try {
        ...
        if (pieces.length === 0) {
            // Afficher un joli message si aucune pièce n'est trouvée
            tableBody.innerHTML = `
                <tr>
