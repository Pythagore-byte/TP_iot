async function chargerDashboard() {
    try {
        ...
        const capteursResponse = await fetch("http://127.0.0.1:8000/capteurs");
        ...
        const consommationResponse = await fetch("http://127.0.0.1:8000/consommation-total");
        ...
        const economiesResponse = await fetch("http://127.0.0.1:8000/economies-total");
