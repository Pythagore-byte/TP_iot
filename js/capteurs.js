...
//         capteurs.forEach((capteur) => {
//             const etatClasse = capteur.etat === "Actif" ? "etat-actif" : "etat-inactif"; // Ajout de classe conditionnelle
//             const row = `
//                 <tr>
//                     <td>${capteur.id}</td>
//                     <td>${capteur.type}</td>
...
//                     <td>${capteur.port_communication}</td>
//                     <td>${capteur.nom_piece || "Non assigné"}</td>
//                     <td>${capteur.derniere_valeur || "Aucune"}</td>
//                     <td>${capteur.date_insertion || "Non disponible"}</td>
//                     <td class="${etatClasse}">${capteur.etat}</td> <!-- Application des styles -->
//                 </tr>
//             `;
//             tableBody.innerHTML += row;
//         });
...
//         capteurs.forEach((capteur) => {
//             // Ajouter une classe conditionnelle pour l'état
...
//                     <td>${capteur.derniere_valeur || "Aucune"}</td>
//                     <td>${capteur.date_insertion || "Non disponible"}</td>
//                     <td class="${etatClasse}">${capteur.etat}</td> <!-- Ajout de la classe ici -->
//                 </tr>
//             `;
//             tableBody.innerHTML += row;
//         });
